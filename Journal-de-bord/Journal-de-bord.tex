...
\begin{center}
	\begin{figure}[H]
		\setlength{\belowcaptionskip}{-35pt}
		\includegraphics[scale=0.3]{images/datavis-medals-world-param.jpeg}
...
Cette visualisation est surtout traversée par un biais de manque de place. 

Ici, le biais est plûtot dans la façon dont cette visualisation est présentée dans notre tableau de bord : comme la carte exigeait beaucoup de place, nous avons dû mettre le diagramme en bas de page et réduire l’espace à sa disposition ; ce faisant, cela écrase les barres et donc fait croire visuellement à l’utilisateur que les pays avec un nombre assez faible de médailles (entre 10 20) n’en ont pas du tout du fait de l’applatissement généraldu diagramme. Qui plus est, cela rend difficile le passage de la souris pour voir une valeur de façon plus précise.
