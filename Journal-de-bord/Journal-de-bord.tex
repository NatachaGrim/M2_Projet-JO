...
Ce deuxième flux est composé de plusieurs petits flux qu'il ne faisait pas sens de joindre en bout de chaîne. 

Et on a utilisé kaggle parce que les médailles



\subsection{Préparation des jeux de \textit{Sport England}}
...
\subsection{Préparation du jeu de Wikidata (régions Angleterre)}
...
\subsection{Royaume-Uni : jointure et préparation du jeu final}
...
\subsection{Préparation du jeu du ministère}
...
\subsection{Préparation du jeu de Wikidata (régions France)}
...
\subsection{France : jointure et préparation du jeu final}
